...
class Visitor(ast.NodeVisitor):
    ...
    def visit_FunctionDef(self, node: ast.FunctionDef) -> None:
        sorted_args, arg_type_lookup = self._collect_all_function_args(node)
    ...
    @classmethod
    def _collect_all_function_args(
            cls,
            node: ast.FunctionDef,
    ) -> Tuple[List, Dict[ast.arg, ArgType]]:
        ...
        return sorted_args, arg_type_lookup
